...
const SystemSettings: FC<SystemSettingsProps> = ({ state }) => {
  const [languageMap, setLanguageMap] = useState<any>({
    systemConfig: { theme: "Theme preference", themeHelper: "restart required to take effect", commandInsert: "New command insert preference",
      camelCase:"Camel case various names in UI",ignoreErrors:"Ignore Certificate/SSL errors",codeExport:"Disable code export compatibility mode"
    }
  });
