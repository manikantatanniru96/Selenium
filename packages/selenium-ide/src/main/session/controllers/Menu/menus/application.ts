   ...
   [
    {
      label: "Selenium IDE",
      submenu: [
        { label:session.store.get('languageMap').electronMenuTree.about,role: "about" },
        { type: "separator" },
        { label:session.store.get('languageMap').electronMenuTree.services,role: "services" },
        { type: "separator" },
        { label:session.store.get('languageMap').electronMenuTree.hideElectron,role: "hide" },
        { label:session.store.get('languageMap').electronMenuTree.hideOthers,role: "hideOthers" },
        { label:session.store.get('languageMap').electronMenuTree.showAll,role: "unhide" },
        { type: "separator" },
        {
